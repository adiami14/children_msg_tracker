...
def is_member_of_building_group(phone_number: str) -> bool :
    participants = _send_get_request(f'/api/default/groups/{BUILDING_GROUP_ID}/participants', None)
...
if '__main__' == __name__:
    pprint(is_member_of_building_group('972523752472'))
